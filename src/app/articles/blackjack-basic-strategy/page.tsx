      ...
      <div className="max-w-2xl mx-auto px-6 sm:px-10 py-12 sm:py-16">
        ...
        <article>
          ...
          <div className="mt-14 p-6 rounded-2xl bg-slate-900/50 border border-slate-800/60">
            ...
            <Link href="/games/blackjack/" className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 ndl-on-accent text-sm font-semibold px-6 py-2.5 rounded-xl transition-all duration-200 hover:-translate-y-0.5 no-underline">
              Play Blackjack
